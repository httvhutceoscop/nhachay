 ...
 *   The form state.
 */
function nhachayhomnay_form_system_theme_settings_alter(&$form, &$form_state) {
    ...
    $form['mtt_settings']['tabs']['basic_settings']['breadcrumb_display'] = array(
        ...
        '#default_value' => theme_get_setting('breadcrumb_display','nhachayhomnay'),
    );
    ...
    $form['mtt_settings']['tabs']['basic_settings']['scrolltop_display'] = array(
        ...
        '#default_value' => theme_get_setting('scrolltop_display', 'nhachayhomnay'),
        '#collapsible' => TRUE,
        '#collapsed' => TRUE,
    );
    ...
    $form['mtt_settings']['tabs']['ie8_support']['responsive_respond'] = array(
        ...
        '#default_value' => theme_get_setting('responsive_respond','nhachayhomnay'),
    ...
    $form['mtt_settings']['tabs']['google_analytic'] = array(
        '#type' => 'fieldset',
    ...
    $form['mtt_settings']['tabs']['google_analytic']['analytic_code'] = array(
        '#type' => 'textarea',
        '#title' => t('Google Analytic Code.'),
        '#default_value' => theme_get_setting('analytic_code','nhachayhomnay'),
        '#description'   => t('Input your analytic tracking code.'),
    );
}